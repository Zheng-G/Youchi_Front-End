...
export class SeriesLogoEditorComponent extends DefaultEditor implements AfterViewInit {
  ...
  updateValue(data) {
    ...
    if (data['response'] === "File uploaded!") {
      ...
      filePath = this.appConfig.apiUrl + '/upload/seriesLogos/' + fileName;
    }
  ...
  public uploaderOptions:NgUploaderOptions = {
    url: this.appConfig.apiUrl + '/uploader/seriesLogos?token=' + this.apiService.getToken(),
    fieldName: 'seriesLogoImage'
  };
