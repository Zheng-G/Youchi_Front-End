...
export class TypeLogoEditorComponent extends DefaultEditor implements AfterViewInit {
  ...
  updateValue(data) {
    ...
    if (data['response'] === "File uploaded!") {
      ...
      filePath = this.appConfig.apiUrl + '/upload/carTypeLogos/' + fileName;
    }
  ...
  public uploaderOptions:NgUploaderOptions = {
    url: this.appConfig.apiUrl + '/uploader/carTypeLogos?token=' + this.apiService.getToken(),
    fieldName: 'carTypeLogoImage'
  };
