...
export class LogoEditorComponent extends DefaultEditor implements AfterViewInit {
  ...
  updateValue(data) {
    ...
    if (data['response'] === "File uploaded!") {
      ...
      filePath = this.appConfig.apiUrl + '/upload/logos/' + fileName;
  ...
  public uploaderOptions:NgUploaderOptions = {
    url: this.appConfig.apiUrl + '/uploader/brandLogos?token=' + this.apiService.getToken(),
    fieldName: 'logoImage'
  };
